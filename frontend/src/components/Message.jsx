...
export default function Message({content, role}){
	...
	if (role =="user"){
		...
		return(
			...
			<motion.div className="border-[#b8c4ff] border bg-white  h-max w-max text-base rounded-2xl p-4 px-5 self-start  max-w-2/3 my-2 transition-all "
			initial={{
				opacity:0,
				y:10
			}}
			...
			>
					...
					<div className={`overflow-hidden   relative  flex prose h-max  transition-all`}>
					<div>
